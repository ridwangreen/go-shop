 ...
 *
 * Version:
 *    $Id: DiGraph.java,v 1.1 2010/04/26 14:16:26 vcss233 Exp $
 *
 * Revisions:
 *    $Log: DiGraph.java,v $
 ...
 *    Initial revision
 *
 *    Revision 1.3  2006/05/04 12:48:38  vcss233
 *    Lab code now works with generics.
 *
 *    Revision 1.2  2006/05/03 01:54:55  vcss233
 *    The Dijkstra code compiles cleanly
 */
...
public interface DiGraph< VKeyT, VDataT, EDataT > {
    ...
    public Collection< VDataT > neighborData( VKeyT key ) throws NoSuchVertexException;
    ...
    public Collection< VKeyT > neighborKeys( VKeyT key ) throws NoSuchVertexException;
