 ...
 *
 * Version:
 *	   $Id: OrderNameComparatorTest.java 406 2011-02-14 03:23:22Z Brian Baum $
 *
 * Revision:
 *	   $Log$
 */
 ...
 *		Jonathan Olin
 */
public class OrderNameComparatorTest {
	
	private OrderNameComparator onc;
	...
	@Test
	public void testOrderNameGreater() {
		assertTrue(onc.compare(o2, o1) > 0);
	}
	
	@Test
	public void testOrderNameLess() {
		assertTrue(onc.compare( o1, o2 ) < 0);
	}
	
	@Test
	public void testOrderNameEqual() {
		assertTrue(onc.compare( o1, o3 ) == 0);
	}
