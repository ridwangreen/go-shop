...
public class Driver {
     ...
     */
    // TODO: Facade should create the GUI objects
	...
	if ( activePlayer == player ){
	    ...
	    if ( space < 0 ){
	    	displayMessage("Illegal Move", activePlayer.getName() + " made an illegal move");
	    } else {
	    	displayMessage("Illegal Move", activePlayer.getName() + " please make another jump");
    ...
    /**
     * Pass a message to be displayed to the user when a game event occurs, no response.
     * 
     * @param title   title for the game event
    ...
    /**
     * Pass a message to be displayed to the user when a game event occurs, return the response
     * 
     * @param title   title for the game event
