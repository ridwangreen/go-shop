...
public class Rules {
    ...
    private final int KING; // Constant to represent a king piece.
    private Vector leftWallPieces; // Positions of the left
	       				         // wall spaces.
    private Vector rightWallPieces; // Positions of the right
						   // wall spaces.
    ...
    public Rules( Board board, Driver driver ) {
    	...
    	leftWallPieces = new Vector();
    	rightWallPieces = new Vector();
     ...
     */
    // TODO: Should move to Board (with Pieces given
    // functionality to determine direction of movement)
     ...
     *  @pre A capture was successful.
     */   
    // TODO: Should move to Board (with help from pieces)
     ...
     *  @pre A capture was successful.
     */ 
    // TODO: Should be done by Board...but probably doesn't
    // need to be a method
     ...
     */
    // TODO: This should be in Board...but doesn't need to be
    // this complicated...and can be a step within 
    // checkForPossibleJumps
     ...
     */
    // TODO: Should be in Board, but rely heavily on Piece-
    // sub-logic for direction
     ...
     */
    // TODO: Not sure why this is different from 
    // checkForNoMoves()...
     ...
     */
    // TODO: Does this need to be something separate? I think
    // that we can just check to see if we go off the edge
     ...
     */
    // TODO: I don't think this is necessary in this form
    // could just be something that happens as a result of
    // making a move
