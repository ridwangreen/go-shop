...
public class LocalPlayer extends Player {
    ...
    public void acceptDraw( Player player ){
    	...
    	int selected = theDriver.displayMessageWithResult("Draw offer", player.getName() + " has requested a draw."
    			+ "\n\nWill you agree to a draw?");
	
    	if ( selected == YES ) {
    		// TODO: Call to Driver, possibly change
    ...
    public void endOfGame( String endMessage ){
    	...
    	// TODO: Driver should just do this, not farm it out to the player
    	theDriver.displayMessage("Game Over", "Game has ended because: " + endMessage);
    ...
    public void endInDraw( Player player ){
    	...
    	// ended in a draw
    	// TODO: Driver should handle this and not farm out to player
    	theDriver.displayMessage("Game Over", player.getName() + "accepted a draw."
